...
const whyHireMeContentEn: WhyHireMeContent = {
    navbar: {
    ...
    presentation: {
        ...
        body: [
            '**Senior/Principal full-stack software engineer** based in **Paraguay and Argentina**, with **8 years of experience**, including **5+ years working fully remote** with distributed teams across product, platform, and integration-heavy environments.',
...
const whyHireMeContentEs: WhyHireMeContent = {
    navbar: {
        postsHref: 'https://dev.to/nicolasmontielf',
        items: [
            { id: 'posts', label: 'Posts' },
    ...
    presentation: {
        ...
        body: [
            '**Ingeniero de software full-stack senior/principal** radicado entre **Paraguay y Argentina**, con **8 años de experiencia**, incluyendo **más de 5 años trabajando 100% remoto** con equipos distribuidos en productos, plataformas e integraciones complejas.',
...
const whyHireMeContentByLocale: Record<Locale, WhyHireMeContent> = {
    en: whyHireMeContentEn,
    es: whyHireMeContentEs,
};

export function getWhyHireMeContent(locale: Locale): WhyHireMeContent {
